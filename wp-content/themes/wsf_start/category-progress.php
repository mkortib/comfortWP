...
<div id="my-content">
    ...
    <main class="wrap about_prog">
        ...
        <section class="s_news s_white sect_top">
            ...
            <h2 class="news_title">Хронология строительства</h2>
            ...
            <div class="nav_wrap">
                ...
                <div class="nav">
                    ...
                    <ul class="nav_titles">
                        ...
                        <li class="active"><a href="/news/progress">Ход строительства</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="news_wrap">
                                ...
                                <div class="after_img">
                                    <div class="date_min">Ход строительства</div>
                                    <h3><?php the_title(); ?></h3>
                                    <?php the_excerpt(); ?>
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/app//sales/SVG/an_rect.svg" class="rect" alt="rect">
