...
if ( ! function_exists( 'wsf_setup' ) ) :
    ...
    function wsf_setup() {
         ...
         */
        load_theme_textdomain( 'wsf_start', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            'primary' => __( 'Primary Menu',      'wsf_start' ),
            'social'  => __( 'Social Links Menu', 'wsf_start' ),
        ) );

        function change_submenu_class($menu) {
            $menu = preg_replace('/ class="sub-menu"/','/ class="drop_down" /',$menu);
            return $menu;
        }
...
//    wp_enqueue_style( 'style', get_stylesheet_uri() );
    wp_enqueue_style( 'wsf-style', get_template_directory_uri() . '/app/css/main.min.css', null, null);
    ...
    // Scripts
    wp_enqueue_script( 'wsf-script', get_template_directory_uri() . '/app/js/scripts.min.js', array( 'jquery' ), null, true );
