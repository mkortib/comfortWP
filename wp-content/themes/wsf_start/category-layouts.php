                        ...
                        <div class="container">
                            ...
                            <div class="row form">
                                ...
                                <div class="col-xl-8 col-12">
                                    ...
                                    <ul class="button_all">
                                        <li class="links_two"><a href="/layouts/" class="but_white act_but">Все</a><a href="/layouts/smart/" class="but_white">Smart</a></li>
                                ...
                                <div class="col-xl-4"><!-- d-none d-xl-block -->
                                    ...
                                    <div class="filter_square">
                                        ...
                                        <div class="selects">
                                            ...
                                            <form>
                                                <div class="inp_t">
                                                    <input type="number" name="min_square" placeholder="От" value="<?php if (isset($_GET['min_square'])) { echo $_GET['min_square']; } ?>">
                                                ...
                                                <div class="item">
                                                    ...
                                                    <div class="plan_descr s_grey">
                                                        ...
                                                        <p class="type_flat"><?php
                                                            if ( in_category('9') ) : echo '1-комнатная квартира' .' (' . esc_html( get_the_title()) . ')';
                                                            elseif ( in_category('8') ) : echo '2-комнатная квартира' .' (' . esc_html( get_the_title()) . ')';
