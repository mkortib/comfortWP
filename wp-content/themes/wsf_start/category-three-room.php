                    ...
                    <div class="container">
                        ...
                        <div class="row form">
                            ...
                            <div class="col-xl-8 col-12">
                                ...
                                <ul class="button_all">
                                    <li class="links_two"><a href="/layouts/smart/" class="but_white">Все</a><a href="#" class="but_white">Smart</a></li>
                                    <li><a href="/layouts/one-room/" class="but_white">1-комнатные</a></li>
                                    <li><a href="/layouts/two-room/" class="but_white">2-комнатны</a></li>
                                    <li><a href="/layouts/three-room/" class="but_white act_but">3-комнатные</a></li>
                                </ul>
                                    ...
                                    <div class="col-12 col-md-6 col-sm-10 col-lg-4">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="plan_descr s_grey">
                                                ...
                                                <p class="type_flat"><?php echo '3-комнатная квартира' .' (' . esc_html( get_the_title()) . ')'; ?></p>
                                                <div class="add_info">
